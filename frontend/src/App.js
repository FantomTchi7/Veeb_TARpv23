...
function App() {
  ...
  useEffect(() => {
      fetch("https://localhost:7129/customer")
        .then(res => res.json())
        .then(json => {
          setCustomers(json);
        });
  ...
  function deleteCustomer(index) {
    ...
    fetch("https://localhost:7129/customer/" + id, {method: "DELETE"})
        .then(res => res.json())
        .then(json => {
          setCustomers(json);
    });
  ...
  function addCustomer() {
    ...
    fetch("https://localhost:7129/customer/", {method: "POST", body: JSON.stringify(newCustomer), headers: {"Content-Type": "application/json"}})
        .then(res => res.json())
        .then(json => {
          setCustomers(json);
  ...
  function getCustomerUsages(customerId) {
    fetch("https://localhost:7129/usage-customer?customerId=" + customerId)
    .then(res => res.json())
    .then(json => {
  ...
  function getCustomerSum() {
    fetch("https://localhost:7129/usage-customer-sum?customerId=" + usagesShownCustomerId)
    .then(res => res.json())
    .then(json => {
      setCustomerSum(json);
    });
  ...
  function addUsage() {
    ...
    fetch("https://localhost:7129/usage/", {method: "POST", body: JSON.stringify(newUsage), headers: {"Content-Type": "application/json"}})
        .then(res => res.json())
        .then(json => {
          setAddUsageCustomerId(-1);
    });
  ...
  useEffect(() => {
    fetch("https://localhost:7129/device")
      .then(res => res.json())
      .then(json => {
        setDevices(json);
      });
  ...
  function deleteDevice() {
    fetch("https://localhost:7129/device/" + deviceSelected, {method: "DELETE"})
      .then(res => res.json())
      .then(json => {
        setDevices(json);
        setDeviceSelected(-1);
  ...
  function addDevice() {
    ...
    fetch("https://localhost:7129/device/", {method: "POST", body: JSON.stringify(newDevice), headers: {"Content-Type": "application/json"}})
        .then(res => res.json())
        .then(json => {
          setDevices(json);
  ...
  useEffect(() => {
    if (start !== null && end !== null) {
      fetch("https://localhost:7129/usage-start-period?startDate=" + start + "&endDate=" + end)
        .then(res => res.json())
        .then(json => {
          console.log(json);
          setUsages(json);
      ...
      fetch("https://localhost:7129/usage")
        .then(res => res.json())
        .then(json => {
          setUsages(json);
        });
